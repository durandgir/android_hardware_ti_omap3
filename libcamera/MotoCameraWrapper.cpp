...
extern "C" sp<CameraHardwareInterface> HAL_openCameraHardware(int cameraId)
{
    ...
    return MotoCameraWrapper::createInstance(cameraId);
}

wp<CameraHardwareInterface> MotoCameraWrapper::singleton;
...
sp<CameraHardwareInterface> MotoCameraWrapper::createInstance(int cameraId)
{
    LOGV("%s :", __func__);
    if (singleton != NULL) {
